...
grafica_error_elman = elman("../originalFiles/dat_entrada.csv",tam_ventana,capa_oculta,capa_entrada,capa_salida,factor_aprendizaje,factor_inercia, max_epocas);

figure(1);
plot(grafica_error_elman,'r-','LineWidth',4);
grid on;
title('Evolución de la tasa de aciertos en el tiempo');
xlabel('Epoca');
ylabel('% aciertos');
legend ("Elman","location", "south") ;

printf("Evaluando la red Jordan...\n");
grafica_error_jordan = jordan("../originalFiles/dat_entrada.csv",tam_ventana,capa_oculta,capa_entrada,capa_salida,factor_aprendizaje,factor_inercia, max_epocas);
