#añadimos los paths de las funciones
...
grafica_error_elman = elman(ruta_fichero,tam_ventana,capa_oculta,capa_entrada,capa_salida,factor_aprendizaje,factor_inercia, max_epocas);
...
grafica_error_jordan = jordan(ruta_fichero,tam_ventana,capa_oculta,capa_entrada,capa_salida,factor_aprendizaje,factor_inercia, max_epocas);
